    ...
    implements ActionListener
{
  ...
  String[] fortunes = { "You will get a 100 on the next test!"
		  ,"You will be a billionaire"
		  , "You are going to be a promising singer"
		  ,"You will see your parents next week"
		  , "You wont have classes tomorrow!"};
  ...
  public void actionPerformed(ActionEvent e)
  {
    ...
    display.setText("  " + fortunes[(int)Math.random()*5] );
    ding.play();
  }
