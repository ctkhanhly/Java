                            ...
                            implements ActionListener
{
  ...
  public VendingMachine(String brand, Color color, int price, ImageIcon coin, Bookeeper b)
  {
    ...
    vendor = new Vendor(price, FULL_STOCK,b);
  }
...
//          "Enjoy your " + brandName + "\n" + " Change" +change+ "c = "+coin.getQuarters() +"q + "+ 
//        coin.getNickels()+"n + "+ coin.getDimes() + "d + "+ coin.getPennies() + "p",
...
//      }
      ...
      {
        JOptionPane.showMessageDialog(null,
          "Take " + change + "c ="+coin.getQuarters() +"q + "+ 
        	        coin.getNickels()+"n + "+ coin.getDimes() + "d + "+ coin.getPennies() + "p back",
          "Money back", JOptionPane.ERROR_MESSAGE);
      }
    }
