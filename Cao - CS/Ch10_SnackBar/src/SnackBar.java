                      ...
                      implements ActionListener
{
  ...
  public SnackBar()
  {
    ...
    Bookeeper b = new Bookeeper();
    VendingMachine[] machines =
    {
      new VendingMachine("Java", brandColor1, 45, coin, b),
      new VendingMachine("JApple", brandColor2, 50, coin,b),
      new VendingMachine("Jinx", brandColor3, 35, coin,b)
    };
  ...
  public void actionPerformed(ActionEvent e)
  {
    ...
    if (MY_PASSWORD.equals(word))
    {
      ...
      double amt = machines[0].getBooks().getTotalSales();
