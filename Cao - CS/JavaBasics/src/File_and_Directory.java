...
public class File_and_Directory extends JFrame{
	static String filePath, parentDirectory;
    static File randomDir, randomFile, randomFile2;

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		File file = new File("text.txt");//chi lam tren bo nho java
//chua tao file
        // Creates a File object in memory- a file named Random
        randomDir = new File("/Users/lycao/Documents/Java code/Random");
        // Make a directory
        randomDir.mkdir();
        // Make a file named random.txt
        randomFile = new File("random.txt");
        // Make a file and define where to save it in the file system
        randomFile2 = new File("/Users/lycao/Documents/Java code/Random/random2.txt");
	...
	try {
		...
		directory.mkdir();//create new Folder( directory)
	...
	} catch (IOException ex) {//file ma ton tai roi thi xoa, de len file ay
		// TODO Auto-generated catch block
		//e.printStackTrace();
		Logger.getLogger(File_and_Directory.class.getName()).log(Level.SEVERE, null,ex);
	}//tao file- IOExp
...
//	        }
	        System.out.println("Test delete()" +randomFile.delete());//true when file exists
	        System.out.println("Test delete()" +randomFile.delete());//false when file does not exist
